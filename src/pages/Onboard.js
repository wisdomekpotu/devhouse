...
export default function Onboard() {
  ...
  const { googleSignIn, githubSignIn, twitterSignIn, facebookSignIn } = useUserAuth()
      ...
      <Box>
        <Container maxWidth="xl"  >
          ...
          >
            ...
            <Button onClick={handleGithubSignIn} variant="contained" style={{ backgroundColor: "white", textTransform: "capitalize", color: "black" }}><img src={github} alt="googleicon" style={{ height: "23px", width: "23px" }} />Github</Button>
