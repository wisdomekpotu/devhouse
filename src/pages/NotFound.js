...
export default function NotFound() {
  return (
    ...
    <Grid container spacing={{ xs: 1, sm: 2, md: 4 }} style={{ justifyContent: "center", margin: "auto" }}>
      <img src={not} alt=" " style={{ margin: "auto", width: "400px",marginRight: "400px", marginTop: "90px", marginLeft: "400px", align: "center" ,textDecoration: "none", fontWeight:"bold" }}/> <br/><br/>
      <Link to="/">
